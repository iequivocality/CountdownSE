 ...
 * Chat Widget
 * 
 * Inspired by Boxed chat by Cocahh 
 * Most JS code is also copied from Boxed Chat
 */

let totalMessages = 0, messagesLimit = 0, nickColor = "user", removeSelector, addition, customNickColor, channelName, provider;
